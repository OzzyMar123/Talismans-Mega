package com.gitea.ozzymar.talismansmega.config.talismans.items;
...
public class MoltenskinConfiguration {
    // The .yml file itself
    ...
    public MoltenskinConfiguration(Plugin plugin, String fileLocation) {
